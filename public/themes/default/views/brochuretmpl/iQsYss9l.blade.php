        ...
        <div class="span10" id="broc-content" >
                ...
                <div class="span6" style="padding-right:10px;padding-top:10px;" >
                    ...
                    <table class="table table-bordered" style="width:380px;margin-bottom:8px;height:310px;">
                        ...
                        <tbody class="rounded" >
                            ...
                            <tr>
                                <th class="item" colspan="2" style="text-align:left;font-style:italic;background-color:#9bdbf5;">Annual Expenses</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="item"  style="text-align:left;font-style:italic;border-bottom:none;background-color:#9bdbf5;">Total Expenses</th><td id="totalExpense" style="border-bottom:none;background-color:#9bdbf5;" >${{ Ks::us($totalExpense) }}</td>
                            </tr>
                            <tr>
            ...
            <div class="row-fluid" >
                ...
                <div class="span6">
                        ...
                        <tbody class="rounded" >
                            <tr class="yield">
                                <th class="item" >3 years with 5% appreciation rate</th><td id="calcROI" style="font-weight:bold;">{{ $roi3 }}%</td>
                            </tr>
                            <tr class="yield">
                                <th class="item" >3 Years with 10% appreciation rate</th><td id="calcROI" style="font-weight:bold;">{{ $roi5  }}%</td>
                            </tr>
                        </tbody>
